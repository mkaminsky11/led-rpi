...
while ip_addr == "127.0.0.1":
	...
	line_2  = font.normalLines(font.arrayToLines(font.textToFont("NICERACK")), 192)
...
while True:
	...
	if music_data != None:
		...
		if title != store_title:
			...
			lines = font.normalLines(font.join3Rows(title_lines,playlist_lines,length_lines), 576)
			send(lines)
		#else:
			#
			#   186 = 100
		...
		title_lines = font.normalLines(font.arrayToLines(font.textToFont("Nicerack is down")), 192)
		playlist_lines = font.normalLines(font.arrayToLines(font.textToFont(":(")), 192)
		length_lines = font.normalLines(font.arrayToLines(font.textToFont("Trying again...")),192)
		lines = font.normalLines(font.join3Rows(title_lines,playlist_lines,length_lines), 576)
